...
4. Open a page with a form, then click the Privacy Lens icon.

The extension never reads or stores input values. It only inspects matching input elements and returns visible geometry.
